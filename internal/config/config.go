...
type Config struct {
	...
	HealthCheckTimeoutSeconds int // Total deadline for post-upgrade health verification (default 120s)
...
func Load() (*Config, error) {
	...
	cfg := &Config{
		...
		HealthCheckTimeoutSeconds: getEnvInt("HEALTH_CHECK_TIMEOUT_SECONDS", 120),
